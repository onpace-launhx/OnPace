...
const features = [
  {
    name: "AI Study Coach Assistant",
    description: "Your personal academic mentor. Discuss difficult subjects, clear doubts, get study tips, and break down goals on the fly.",
    icon: Sparkles,
    color: "bg-indigo-50 border-indigo-100 text-indigo-600",
  },
  {
    name: "Interactive AI Flashcards",
    description: "Paste notes or textbook pages and watch AI compile comprehensive card decks. Interactive 3D flip card visual review desks.",
    icon: BookMarked,
    color: "bg-purple-50 border-purple-100 text-purple-600",
  },
  {
    name: "Diagnostic Exam Quizzes",
    description: "Evaluate your prep level. AI drafts customized multiple-choice practice items, complete with descriptive answer explanations.",
    icon: Trophy,
    color: "bg-amber-50 border-amber-100 text-amber-600",
  },
  {
    name: "Smart Task Breakdown",
    description: "Overwhelmed by huge assignments? AI splits your master checklists into 3 small, actionable sub-tasks.",
    icon: CheckCircle2,
    color: "bg-emerald-50 border-emerald-100 text-emerald-600",
  },
  {
    name: "Pomodoro Focus Cabinets",
    description: "Built-in timers and ambient sound controllers (rain, white noise) help you stay in the zone and record actual deep work minutes.",
    icon: BrainCircuit,
    color: "bg-cyan-50 border-cyan-100 text-cyan-600",
  },
  {
    name: "Integrated Study Calendar",
    description: "Map your tasks, exam dates, and courses in a unified visual timeline to prevent last-minute cramming.",
    icon: Calendar,
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center space-y-3">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight text-surface-dark sm:text-4xl">
            Study smarter, stay on track.
          </h2>
          <p className="text-base text-gray-500 font-medium">
            OnPace integrates all your school planning, checklist tasks, note storage, and AI diagnostics into a single dashboard.
          </p>
        </div>
